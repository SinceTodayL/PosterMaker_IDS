...
# stage2 eval
STAGE2_GT_IM_SAVE_PATH = '../dataset/eval_poster_stage2/gt/'
STAGE2_SUBJECT_MASK_SAVE_PATH = '../dataset/eval_poster_stage2/mask/'
STAGE2_DATA_SAMPLES_PATH = '../dataset/eval_poster_stage2/eval_data.json'

# stage1 eval
STAGE1_GT_IM_SAVE_PATH = '../dataset/eval_poster_stage1/gt/'
STAGE1_SUBJECT_MASK_SAVE_PATH = '../dataset/eval_poster_stage1/mask/'
STAGE1_DATA_SAMPLES_PATH = '../dataset/eval_poster_stage1/eval_data.json'
