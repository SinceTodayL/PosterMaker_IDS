...
class SD3ControlNetModel(
    ...
    def from_transformer(
        ...
        # Ensure all necessary parameters from the transformer's config are passed to the ControlNet's config
        controlnet_config = {
            ...
            "additional_in_channel": additional_in_channel,
        }
    ...
    def forward(
        ...
        # 兜底处理：如果pooled_projections为None，创建零向量
