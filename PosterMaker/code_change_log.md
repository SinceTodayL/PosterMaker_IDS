...
**File: ** `utils/ids_query.py` 以及 `test_ids_query.py`
...
# Usage:
ids_query = IDSQuery()
result = ids_query.query_text('同济大学')

#Output:
[{'同': {'simple': '⿵冂𠮛', 'recursive': '⿵冂⿱一口'}}, {'济': {'simple': '⿰氵齐', 'recursive': '⿰氵⿱⿱⿱丶一乂⿰丿丨'}}, {'大': {'simple': '⿻一人', 'recursive': '⿻ 一人'}}, {'学': {'simple': '⿱𰃮子', 'recursive': '⿱⿱⿲丶丶㇒冖⿻⿱乛亅一'}}]
```
