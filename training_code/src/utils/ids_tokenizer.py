...
class IDSTokenizer:
    ...
    def __init__(self, ids_database_path: str, vocab_file: Optional[str] = None, 
        ...
        Args:
            ...
            vocab_file: Path to vocabulary file (will be created if doesn't exist)
        ...
        # Special tokens with consistent IDs (will be loaded from vocab)
        self.special_tokens = {}
        
        # IDS structural descriptors (will be loaded from vocab)
        self.idc_chars = set()
        ...
        # Load or build vocabulary automatically
